...
## Environments
- Preview: https://main--manasmaji-da-test1--aemysites.aem.page/
- Live: https://main--manasmaji-da-test1--aemysites.aem.live/
- Block Library: https://main--manasmaji-da-test1--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `manasmaji-da-test1` directory in your favorite IDE and start coding :)
